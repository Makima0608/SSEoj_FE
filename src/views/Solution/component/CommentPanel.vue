...
import { getSolution1stCommentAPI, likeSolutionCommentAPI, getSolution2ndCommentAPI, commentSolutionAPI } from '@/apis/problemset';
...
// 获取一级评论
const getSolution1stComment = async() => {
    const res = await getSolution1stCommentAPI(props.id, reqData.value)
